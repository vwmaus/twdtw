...
#' #twdtw(x, y, max_elapsed = 20, NP = as.integer(length(TW)
#' #   tw_r = function(dist,td,tw1,tw2) dist + 1.0 / (1.0 + exp(-0.1 * (td - 50))))
#'
#' twdtw(x, y, tw = c(-.1, 50, 50), NPAR = as.integer(3))
#'
...
#'
#' @export
twdtw <- function(x, y, tw = c(-0.1, 50, 50), step_matrix = symmetric1, version = 'f90',
